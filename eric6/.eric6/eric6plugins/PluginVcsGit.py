...
from vcsGit.GitUtilities import getConfigPath
...
def createConfigurationPage(configDlg):
    ...
    from vcsGit.ConfigurationPage.GitPage import \
        GitPage
...
def getConfigData():
    ...
    return {
        ...
        [QCoreApplication.translate("VcsGitPlugin", "Git"),
            os.path.join("vcsGit", "icons", "preferences-git.png"),
...
class VcsGitPlugin(QObject):
    ...
    def getPreferences(cls, key):
        ...
        if key in ["StopLogOnCopy", "ShowReflogInfo", "ShowAuthorColumns",
                   "ShowCommitterColumns", "AggressiveGC"]:
