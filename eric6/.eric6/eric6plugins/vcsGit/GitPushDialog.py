...
class GitPushDialog(QDialog, Ui_GitPushDialog):
    ...
    def getData(self):
        ...
        @return tuple of remote name, list of branches to be pushed,
            a flag indicating to push tags as well and a flag indicating
            to set tracking information (string, list of strings, boolean,
            boolean)
        """
        refspecs = []
        for row in range(self.branchesTree.topLevelItemCount()):
