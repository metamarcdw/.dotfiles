...
class GitLogBrowserDialog(QWidget, Ui_GitLogBrowserDialog):
    ...
    def __initLogTreeContextMenu(self):
        ...
        self.__showAuthorAct = self.__logTreeMenu.addAction(
            self.tr("Show Author Columns"))
        self.__showAuthorAct.triggered.connect(
            self.__showAuthorColumns)
        self.__showAuthorAct.setToolTip(self.tr(
            "Press to show the author columns"))
        self.__showAuthorAct.setCheckable(True)
        self.__showAuthorAct.setChecked(self.vcs.getPlugin().getPreferences(
            "ShowAuthorColumns"))
        self.__showAuthorColumns(self.vcs.getPlugin().getPreferences(
            "ShowAuthorColumns"))
        
        self.__showCommitterAct = self.__logTreeMenu.addAction(
            self.tr("Show Committer Columns"))
        self.__showCommitterAct.triggered.connect(
            self.__showCommitterColumns)
        self.__showCommitterAct.setToolTip(self.tr(
            "Press to show the committer columns"))
        self.__showCommitterAct.setCheckable(True)
        self.__showCommitterAct.setChecked(self.vcs.getPlugin().getPreferences(
