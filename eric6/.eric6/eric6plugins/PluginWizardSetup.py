...
deactivateable = True
version = "2.0.4"
className = "WizardSetupPlugin"
packageName = "WizardSetup"
...
class WizardSetupPlugin(QObject):
    """
        ...
        if self.__ui is not None:
            ...
            if loc and loc != "C":
                locale_dir = os.path.join(
                    os.path.dirname(__file__), "WizardSetup", "i18n")
                translation = "setup_{0}".format(loc)
    ...
    def __callForm(self, editor):
        ...
        """
        from WizardSetup.SetupWizardDialog import SetupWizardDialog
